        ...
        <div className="home">
             <div className="home__section-1">
                 ...
                 <div className="home__section-1-cta">
                     ...
                     <button className="home__button-btn"><a href="#about-me">ABOUT ME</a></button>
                     </div>
                 </div>
             </div>
             <div className="home__section-2">
               ...
               <div className="home__section-2-about" id="about-me">
                    ...
                    <button className="home__section-2-cta"><Link to="/projects">Go to portfolio</Link></button>
               </div>
             </div>
        </div>
    )
